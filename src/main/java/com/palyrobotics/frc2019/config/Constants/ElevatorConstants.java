...
public class ElevatorConstants {
    ...
    public static final double kElevatorCargoHeight2Inches = -38.5;
     ...
     * Unit Conversions
     */
    public static final double kSpoolEffectiveDiameter = 2.9;
    public static final double kElevatorRotationsPerInch = (1.0 / (kSpoolEffectiveDiameter * Math.PI)) * (52.0/12.0) * (50.0/26.0) * (60/40);
