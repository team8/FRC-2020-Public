...
public class prank extends AutoModeBase {
    ...
    public Routine placeHatchClose1() { //start to rocket ship close
        ...
        StartToRocketShip.add(new Waypoint(new Translation2d(50,
                0), kRunSpeed)); //goes straight at the start so the robot doesn't get messed up over the ramp
        StartToRocketShip.add(new Waypoint(new Translation2d(150,
                0), kRunSpeed, "visionStart")); //line up with rocket ship
        StartToRocketShip.add(new Waypoint(new Translation2d(200,
                0), 0));
...
//                22)), 0));
        ...
        routines.add(new DrivePathRoutine(BackRocketShipToLoadingStation, true, false));
        ...
        ForwardRocketShipToLoadingStation.add(new Waypoint(new Translation2d(100,
                -40), kRunSpeed));
        ForwardRocketShipToLoadingStation.add(new Waypoint(new Translation2d(170,
                -60), kRunSpeed));
