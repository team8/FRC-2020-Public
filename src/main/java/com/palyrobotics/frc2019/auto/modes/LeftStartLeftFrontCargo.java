...
public class LeftStartLeftFrontCargo extends AutoModeBase {
    ...
    public Routine placeHatch(boolean inverted) {
        ...
        StartToCargoShip.add(new Waypoint(new Translation2d(invertCord * (kHabLineX + PhysicalConstants.kRobotLengthInches + kOffsetX), 0), kRunSpeed));
        ...
        StartToCargoShip.add(new Waypoint(new Translation2d(invertCord * (kCargoShipLeftFrontX - PhysicalConstants.kRobotLengthInches * 2 + kOffsetX), invertCord * (kCargoShipLeftFrontY + kOffsetY)), 0));
