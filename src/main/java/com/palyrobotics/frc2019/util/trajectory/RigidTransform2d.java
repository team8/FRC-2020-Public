...
public class RigidTransform2d implements Interpolable<RigidTransform2d> {
	...
	public static RigidTransform2d fromVelocity(Delta delta) {
		...
		return new RigidTransform2d(new Translation2d(delta.dx * s - delta.dy * c, delta.dx * c + delta.dy * s), new Rotation2d(cos_theta, sin_theta, false));
	}
	...
	public RigidTransform2d transformBy(RigidTransform2d other) {
		return new RigidTransform2d(translation_.translateBy(other.translation_.rotateBy(rotation_)), rotation_.rotateBy(other.rotation_));
	}
	...
	public RigidTransform2d interpolate(RigidTransform2d other, double x) {
		...
		return new RigidTransform2d(translation_.interpolate(other.translation_, x), rotation_.interpolate(other.rotation_, x));
	}
