...
public class DriveTurnController extends Drive.DriveController {
	...
	private ProfiledPIDController mController = new ProfiledPIDController(mDriveConfig.turnGains.p, mDriveConfig.turnGains.i,
																		  mDriveConfig.turnGains.d,
																		  new TrapezoidProfile.Constraints(mDriveConfig.turnGains.velocity,
																										   mDriveConfig.turnGains.acceleration
																		  )
	);
