...
public class ControllerOutput {
    ...
    public enum Mode {
        PERCENT_OUTPUT,
        POSITION, VELOCITY,
        PROFILED_POSITION, PROFILED_VELOCITY,
    }
    ...
    public String toString() {
        return String.format("Output{mMode=%s, mGains=%s, mReference=%s, mArbitraryDemand=%s}", mMode, mGains, mReference, mArbitraryDemand);
    }
}
