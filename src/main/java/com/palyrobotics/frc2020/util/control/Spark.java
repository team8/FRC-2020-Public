...
public class Spark extends CANSparkMax {
    ...
    public static final Map<ControllerOutput.Mode, ControlType> MODE_TO_CONTROLLER = Map.of(
            ControllerOutput.Mode.PERCENT_OUTPUT, ControlType.kDutyCycle,
            ControllerOutput.Mode.POSITION, ControlType.kPosition,
            ControllerOutput.Mode.VELOCITY, ControlType.kVelocity,
            ControllerOutput.Mode.PROFILED_POSITION, ControlType.kSmartMotion,
            ControllerOutput.Mode.PROFILED_VELOCITY, ControlType.kSmartVelocity
    );
    ...
    private final ProfiledControllerBase mController = new ProfiledControllerBase() {
        ...
        boolean setReference(ControllerOutput.Mode mode, int slot, double reference, double arbitraryPercentOutput) {
            ...
            return mHardwareController.setReference(reference, controllerType, slot, arbitraryPercentOutput, ArbFFUnits.kPercentOut) == CANError.kOk;
        }
