...
public class Talon extends TalonSRX {
    ...
    public static final Map<ControllerOutput.Mode, ControlMode> MODE_TO_CONTROLLER = Map.of(
            ControllerOutput.Mode.PERCENT_OUTPUT, ControlMode.PercentOutput,
            ControllerOutput.Mode.POSITION, ControlMode.Position,
            ControllerOutput.Mode.VELOCITY, ControlMode.Velocity,
            ControllerOutput.Mode.PROFILED_POSITION, ControlMode.MotionMagic,
            ControllerOutput.Mode.PROFILED_VELOCITY, ControlMode.MotionProfile
    );
