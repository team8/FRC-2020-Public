...
public class GenericCircularBuffer<E> {
	...
	public GenericCircularBuffer(int window_size) {
	...
	public LinkedList<E> getLinkedList() {
		...
		* ClassThatIWant[specificCircularBufferGeneric .getLinkedList().size()]); The
		* reason is that for some reason an array of a generic class(i.e. E[]) cannot
		* be created because of some archaic data flow ambiguities
		*/
