...
public class ShootThreeEnemyRendezvousThreeFriendlyTrenchRunTwoShootFive extends AutoModeBase {
	...
	public RoutineBase getRoutine() {
		...
		routines.add(
				new DriveParallelPathRoutine(new IntakeBallRoutine(0.0), new DrivePathRoutine(enemyrendezvous), 0.8));

		routines.add(new DriveParallelPathRoutine(new IntakeBallRoutine(0.0), new DrivePathRoutine(aroundTrench), 0.8));
