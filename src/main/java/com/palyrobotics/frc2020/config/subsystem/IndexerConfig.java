...
public class IndexerConfig extends SubsystemConfigBase {
	public double sparkIndexingOutput, leftTalonIndexingOutput, rightTalonIndexingOutput, feedingOutput, reversingOutput, reverseTime, caterpillarTargetEncoderTicks, maxPercentOutputCaterpillar;
