...
public class DrivetrainConstants {
	 ...
	 */
	public static final double kTurnInPlacePower = 0.45, // For bang bang
			kVisionLookingForTargetCreepPower = 0.18, kDriveMaxClosedLoopOutput = 0.8, kVisionTargetThreshold = 5; // Threshold
																													// before
																													// target
																													// cannot
																													// be
	 ...
	 * Tolerances
	 */
	public static final double kAcceptableDrivePositionError = 15, kAcceptableDriveVelocityError = 5,
			kAcceptableShortDrivePositionError = 1, kAcceptableShortDriveVelocityError = 3,
			kAcceptableTurnAngleError = 4, kAcceptableGyroZeroError = 3, kAcceptableEncoderZeroError = 50;
	 ...
	 */
	public static double kDeadBand = 0.02, kCyclesUntilStop = 50;
}
