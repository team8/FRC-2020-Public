...
import com.palyrobotics.frc2020.util.trajectory.PathSegment;
...
public class PathTest {
	...
	public void testNumericalStability() {
		...
		for(int i = 0; i < 10000; ++i) {
			...
			Path path = new Path(waypoints);
			for(int j = 0; j < 50; ++j) {
				Translation2d robot_position = new Translation2d(rand.nextDouble() * 10.0 + 24, rand.nextDouble() * 10.0 + 18);
				path.update(robot_position);
